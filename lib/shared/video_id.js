(function(global){
  ...
  try{
    if(!global.getVideoIdFromUrl) global.getVideoIdFromUrl = getVideoIdFromUrl;
    if(!global.buildCanonicalWatchUrl) global.buildCanonicalWatchUrl = buildCanonicalWatchUrl;
  }catch(e){}
})(self);